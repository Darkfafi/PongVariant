		...
		public function movement():void 
		{
			if (ball.dir == 1 && player.scaleY > 0.5) {
				...
				if(ball.x > stage.stageWidth / chance){
					if (ball.y - player.y - player.height < 20 && ball.y - player.y - player.height > -20) {
						player.dir = 0;
					}
				...
				if (stage.stageHeight / 2 - player.y - player.height < 20 && stage.stageHeight / 2 - player.y - player.height > -20) {
					player.dir = 0;
				}
